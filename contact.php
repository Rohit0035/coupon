                                ...
                                <div class="col-md-7">
                                    <div class="post-comment-form-group">
                                        <form action="#" method="post" id="cbx-contact-form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="submit" value="Send Your Message" class="btn btn-block btn-brand btn-lg">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="col-md-5">
                                    <div class="contact-hotline">
                                        ...
                                        <div class="hotline-thumb">
                                            <img src="assets/img/contact/mr_helpline.jpg" alt="" class="img-responsive img-rounded"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="contact-info-wrapper">
                                        ...
                                        <h6>Contact Info:</h6>
                                        <p><i class="fa fa-phone"></i>88017544-514154, <i class="fa fa-phone"></i>881475 24456 55</p>
                                        <p><i class="fa fa-envelope"></i>info@couponzgmail.com, <i class="fa fa-globe"></i>www.domain.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
