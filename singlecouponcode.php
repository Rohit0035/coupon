            ...
            <div class="row">
                <div class="col-md-3 col-xs-12">
                    <div class="single-coupon-thumb">
                        <img src="assets/img/deal/deal12.jpg" alt="Coupon" class="img-responsive">
                    </div>
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="single-coupon-content">
                        <h5>Special Flash Sale</h5>
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                        <p class="expiring-time"><span class="btn btn-brand coupon-type">Code</span><i class="fa fa-clock-o"></i> 0 days, 0h Remaining</p>
